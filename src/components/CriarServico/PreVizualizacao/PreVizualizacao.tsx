             ...
             <aside className="xl:sticky xl:top-20 xl:self-start">
              ...
              <Card className={`${createServiceCardClass} overflow-hidden`}>
                ...
                <CardContent className="space-y-2 pt-4">
                  <p className="text-[10px] font-bold uppercase tracking-[0.12em] text-[#2350d4]">{informacao.categoria || "Categoria"}</p>
                  <h3 className="text-base font-semibold text-[#1a1a18] [font-family:Fraunces,serif]">{informacao.titulo || "Titulo do seu servico"}</h3>
                  <p className="text-xs leading-relaxed text-[#8a8a82]">
                   {informacao.descricao || "A descricao aparecera aqui conforme voce preenche o formulario ao lado."}
                  </p>
                  ...
                  <div className="flex items-end justify-between pt-1">
                    ...
                    <span className="text-lg font-bold text-[#1a1a18]">R${informacao.valor.toFixed(2)} <span className="text-xs font-normal text-[#8a8a82]">/ servico</span></span>
                  </div>
                </CardContent>
              </Card>
